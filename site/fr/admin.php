...
<div class="admin-container">
    <div class="sidebar">
        ...
        <div class="menu-section">
            ...
            <ul>
                <li class="<?= isActive('utilisateur-gestion', $section) ?>">
                    <a href="?section=utilisateur-gestion">Gérer les comptes</a>
                </li>
                <li class="<?= isActive('utilisateur-creation', $section) ?>">
                    <a href="?section=utilisateur-creation">Créer des comptes</a>
                </li>
            </ul>
        </div>
    ...
    <div class="main-content">
        ...
        <div  class="content-section <?= isActive('utilisateur-gestion', $section) ?>">
            <h2>Gestion des utilisateurs</h2>
            <?php include("php/admin/gerer-compte.php"); ?>

        </div>

         <div  class="content-section <?= isActive('utilisateur-creation', $section) ?>">
            <h2>Creer des utilisateurs</h2>
            <?php include("php/admin/creer-compte.php"); ?>
